...
from code_2.constrain import *
from code_2.objective_problem import objective
import pandas as pd

x = np.zeros(24)
b = (0.0, None)
bounds = (b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b, b)
...
cons = ([
    ...
    con12, con13, con14, con15, con16, con17, con18, con19  # 第二问
])
...
df_result.to_csv('q2.csv', float_format='%.1f', index=False)
